...
class Gethealthheadlines extends Component {
  // Initial state
  constructor(props) {
    super(props);
  ...
  componentDidMount() {
    return fetch(
      "https://newsapi.org/v2/top-headlines?country=us&category=health&apiKey=dc556b2f972846a6828887a615befecb"
    )
...
export default withNavigation(Gethealthheadlines);
